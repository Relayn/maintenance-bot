...
def main() -> None:
    ...
    application.add_handler(CallbackQueryHandler(admin.admin_user_callback, pattern=r"^delete_user:"))
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, common.unauthorized_user_handler))
